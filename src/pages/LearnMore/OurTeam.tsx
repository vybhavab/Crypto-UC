        ...
        <Box textAlign="center" fontSize="xl">            
            <Grid minH="90vh" p={3}>
                <VStack>
                    ...
                    <HStack spacing={10}>
                        <TeamMemberCard image={vybhav} name={"Vybhav Bhargav"} role={"Full Stack Developer"} email={"vacharbh@ucdavis.edu"} imageSrc={jeju3} linkedIn={"vybhavb"}></TeamMemberCard>
                        <TeamMemberCard image={seongwoo} name={"Seongwoo Choi"} role={"Frontend Developer"} email={"shjchoi@ucdavis.edu"} imageSrc={jeju1} linkedIn={"swchoi1994"}></TeamMemberCard>
                        <TeamMemberCard image={david_haddad} name={"David Haddad"} role={"Full Stack Developer"} email={"davhaddad@ucdavis.edu"} imageSrc={lebanon} linkedIn={"davidhaddad7"}></TeamMemberCard>
                        <TeamMemberCard image={sai} name={"Sairamvinay V."} role={"Backend Developer"} email={"saivijay@ucdavis.edu"} imageSrc={jeju2} linkedIn={"sairamvinay"}></TeamMemberCard>
                    </HStack>
                </VStack>
            </Grid>
        </Box>
